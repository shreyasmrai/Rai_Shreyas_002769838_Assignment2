...
public class PatientLogin extends javax.swing.JPanel {
    ...
    public PatientLogin(DoctorDatabase doctordatabase,VitalSignDatabase vitalsigndatabase, PatientDatabase persondatabase, CommunityDatabase communitydatabase, HospitalDatabase hospitaldatabase, AppointmentDatabase appointmentdatabase) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Patient p = persondatabase.getPerson(username, pswd);
        
         if((p!=null)) {
             PatientMain patient = new PatientMain(p,doctordatabase, persondatabase, communitydatabase, hospitaldatabase, appointmentdatabase);
